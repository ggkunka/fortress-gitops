...
*/}}
{{- define "ingestion-service.chart" -}}
...
helm.sh/chart: {{ include "ingestion-service.chart" . }}
{{ include "ingestion-service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "ingestion-service.serviceAccountName" -}}
{{- default (include "ingestion-service.fullname" .) .Values.serviceAccount.name }}
{{- end }}