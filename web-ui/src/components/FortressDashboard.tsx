...
const FortressDashboard: React.FC<FortressDashboardProps> = ({ userRole = 'admin', permissions }) => {
              ...
              <Button
                ...
                sx={{
                  ...
                  backgroundColor: activeView === tab.id ? 
                    'linear-gradient(135deg, #2563eb, #7c3aed)' : 'transparent',
                  background: activeView === tab.id ? 
                    'linear-gradient(135deg, #2563eb, #7c3aed)' : 'transparent',
                  '&:hover': {
                    backgroundColor: activeView === tab.id ? 
                      'linear-gradient(135deg, #1d4ed8, #6d28d9)' : 'rgba(255,255,255,0.1)',
                    background: activeView === tab.id ? 
                      'linear-gradient(135deg, #1d4ed8, #6d28d9)' : 'rgba(255,255,255,0.1)'
                  },
                  borderRadius: 1.5,
      ...
      <AnimatePresence mode="wait">
        ...
        {activeView === 'runtime' && (
          <motion.div
            ...
            transition={{ duration: 0.3 }}
          >
            <RuntimeSecurityAlerts expanded={true} />
          </motion.div>
        )}
        ...
        {activeView === 'compliance' && (
          <motion.div
            ...
            transition={{ duration: 0.3 }}
          >
            <ComplianceFrameworks expanded={true} />
          </motion.div>
        )}
