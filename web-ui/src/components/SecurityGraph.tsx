...
const SecurityGraph: React.FC<SecurityGraphProps> = ({
  ...
  const getNodeIcon = (type: string) => {
    switch (type) {
      case 'cve': return CVEIcon;
      case 'cluster': return ClusterIcon;
      case 'pod': return PodIcon;
      case 'process': return ProcessIcon;
      case 'syscall': return SyscallIcon;
      case 'file': return FileIcon;
      case 'network': return NetworkIcon;
      default: return CVEIcon;
    }
  };
  ...
  useEffect(() => {
    ...
    const simulation = d3.forceSimulation(filteredData.nodes as any)
      ...
      .force('collision', d3.forceCollide().radius((d: any) => (d.size || 30) / 2 + 5));
    ...
    nodes.filter((d: any) => d.type === 'cve' && d.severity)
      .append('circle')
      .attr('r', 8)
            ...
            {selectedNode.severity && (
              <Box sx={{ mb: 2 }}>
                ...
                <Chip
                  ...
                  color={
                    selectedNode.severity === 'critical' ? 'error' :
